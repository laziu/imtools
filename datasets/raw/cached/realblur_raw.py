...
from ..realblur_raw import RealBlurRaw as _RealBlurRaw_Original
from .common import CropConfig, CachedCropDataset


class RealBlurRaw(CachedCropDataset):
    def __init__(self, data_dir: str, datalist_path: str, cache_dir: str,
                 ...
                 **kwargs):
        """ RealBlur RAW - RGB dataset, with cache.
        ...
        """
        super().__init__(
            dataset=_RealBlurRaw_Original(data_dir, datalist_path, normalize=False),
            cache_dir=cache_dir,
    ...
    def get_inst_name(self, idx: int) -> Path:
        ...
        return raw_path.split("/")[0] + Path(raw_path).stem
