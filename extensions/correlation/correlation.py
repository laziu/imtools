...
class CorrelationFunction(Function):
    ...
    def forward(ctx, input1, input2, pad_size, kernel_size, max_displacement, stride1, stride2, corr_multiply):
        ...
        with torch.cuda.device_of(input1):
            ...
            _ext_correlation.forward(input1, input2, rbot1, rbot2, output,
    ...
    def backward(ctx, grad_output):
        ...
        with torch.cuda.device_of(input1):
            ...
            _ext_correlation.backward(input1, input2, rbot1, rbot2, grad_output, grad_input1, grad_input2,
